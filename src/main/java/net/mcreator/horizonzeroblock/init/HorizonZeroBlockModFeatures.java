...
public class HorizonZeroBlockModFeatures {
	...
	public static final RegistryObject<Feature<?>> MEDICINAL_BRIGHT_OMEN = REGISTRY.register("medicinal_bright_omen",
			MedicinalBrightOmenFeature::feature);
	public static final RegistryObject<Feature<?>> MEDICINAL_FRESH_SALVEBRUSH = REGISTRY.register("medicinal_fresh_salvebrush",
			MedicinalFreshSalvebrushFeature::feature);
	...
	public static final RegistryObject<Feature<?>> MEDICINAL_HINTERGOLD = REGISTRY.register("medicinal_hintergold",
			MedicinalHintergoldFeature::feature);
	public static final RegistryObject<Feature<?>> MEDICINAL_OCHREBLOOM = REGISTRY.register("medicinal_ochrebloom",
			MedicinalOchrebloomFeature::feature);
	public static final RegistryObject<Feature<?>> MEDICINAL_SALVEBRUSH = REGISTRY.register("medicinal_salvebrush",
			MedicinalSalvebrushFeature::feature);
	...
	public static final RegistryObject<Feature<?>> MEDICINAL_VALEYS_BRUSH = REGISTRY.register("medicinal_valeys_brush",
			MedicinalValeysBrushFeature::feature);
	...
	public static final RegistryObject<Feature<?>> MEDICINAL_WILD_EMBER = REGISTRY.register("medicinal_wild_ember",
			MedicinalWildEmberFeature::feature);
