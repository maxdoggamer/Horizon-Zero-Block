	...
	public static void execute(Entity entity) {
		...
		if (true) {
			...
			}
			{
				...
				}.getAmount(0) + (entity.getCapability(HorizonZeroBlockModVariables.PLAYER_VARIABLES_CAPABILITY, null)
		...
		if (true) {
			...
			}
			{
				...
				}.getAmount(1) + (entity.getCapability(HorizonZeroBlockModVariables.PLAYER_VARIABLES_CAPABILITY, null)
		...
		if (true) {
			...
			}
			{
				...
				}.getAmount(2) + (entity.getCapability(HorizonZeroBlockModVariables.PLAYER_VARIABLES_CAPABILITY, null)
		...
		if (true) {
			...
			}
			{
				...
				}.getAmount(3) + (entity.getCapability(HorizonZeroBlockModVariables.PLAYER_VARIABLES_CAPABILITY, null)
		...
		if (true) {
			...
			}
			{
				...
				}.getAmount(4) + (entity.getCapability(HorizonZeroBlockModVariables.PLAYER_VARIABLES_CAPABILITY, null)
		...
		if (true) {
			...
			}
			{
				...
				}.getAmount(5) + (entity.getCapability(HorizonZeroBlockModVariables.PLAYER_VARIABLES_CAPABILITY, null)
		...
		if (true) {
			...
			}
			{
				...
				}.getAmount(6) + (entity.getCapability(HorizonZeroBlockModVariables.PLAYER_VARIABLES_CAPABILITY, null)
		...
		if (true) {
			...
			}
			{
				...
				}.getAmount(7) + (entity.getCapability(HorizonZeroBlockModVariables.PLAYER_VARIABLES_CAPABILITY, null)
