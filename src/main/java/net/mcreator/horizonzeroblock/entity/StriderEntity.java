...
import net.mcreator.horizonzeroblock.procedures.StriderRightClickedOnEntityProcedure;
import net.mcreator.horizonzeroblock.procedures.StriderEntityIsHurtProcedure;
...
public class StriderEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(HorizonZeroBlockModEntities.STRIDER.get(), 200, 2, 6));
	}
