...
import net.mcreator.horizonzeroblock.procedures.TearBowProjectileHitsLivingEntityProcedure;
...
public class TearBowEntity extends AbstractArrow implements ItemSupplier {
	...
	public static TearBowEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
