...
import net.mcreator.horizonzeroblock.procedures.ScrapperRightClickedOnEntityProcedure;
import net.mcreator.horizonzeroblock.procedures.ScrapperOnEntityTickUpdateProcedure;
import net.mcreator.horizonzeroblock.procedures.ScrapperEntityIsHurtProcedure;
...
public class ScrapperEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER)
				.add(new MobSpawnSettings.SpawnerData(HorizonZeroBlockModEntities.SCRAPPER.get(), 130, 2, 4));
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new RemoveBlockGoal(HorizonZeroBlockModBlocks.SCRAP_PILE.get(), this, 1, (int) 3));
	...
	public void aiStep() {
		...
		for (int l = 0; l < 4; ++l) {
			...
			world.addParticle((SimpleParticleType) (HorizonZeroBlockModParticleTypes.SPARK.get()), x0, y0, z0, dx, dy, dz);
		}
	}

	public static void init() {
		SpawnPlacements.register(HorizonZeroBlockModEntities.SCRAPPER.get(), SpawnPlacements.Type.ON_GROUND,
