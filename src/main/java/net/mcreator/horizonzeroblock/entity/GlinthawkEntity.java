...
public class GlinthawkEntity extends Monster implements RangedAttackMob {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new Goal() {
			...
			public boolean canContinueToUse() {
				return GlinthawkEntity.this.getMoveControl().hasWanted() && GlinthawkEntity.this.getTarget() != null && GlinthawkEntity.this.getTarget().isAlive();
			}
		...
		this.goalSelector.addGoal(4, new RandomStrollGoal(this, 2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = GlinthawkEntity.this.getRandom();
	...
	public static void init() {
		SpawnPlacements.register(HorizonZeroBlockModEntities.GLINTHAWK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
