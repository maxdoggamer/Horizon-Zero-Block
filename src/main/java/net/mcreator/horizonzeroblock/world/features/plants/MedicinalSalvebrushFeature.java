...
public class MedicinalSalvebrushFeature extends RandomPatchFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils
				.register("horizon_zero_block:medicinal_salvebrush", FEATURE,
						FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
								new SimpleBlockConfiguration(
										BlockStateProvider.simple(HorizonZeroBlockModBlocks.MEDICINAL_SALVEBRUSH.get().defaultBlockState())),
								List.of(), 64));
		PLACED_FEATURE = PlacementUtils.register("horizon_zero_block:medicinal_salvebrush", CONFIGURED_FEATURE, List.of(CountPlacement.of(5),
