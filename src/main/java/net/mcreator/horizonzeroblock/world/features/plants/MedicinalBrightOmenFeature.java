	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("horizon_zero_block:medicinal_bright_omen", FEATURE,
				FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
						new SimpleBlockConfiguration(BlockStateProvider.simple(HorizonZeroBlockModBlocks.MEDICINAL_BRIGHT_OMEN.get())), List.of(),
						64));
		PLACED_FEATURE = PlacementUtils.register("horizon_zero_block:medicinal_bright_omen", CONFIGURED_FEATURE, List.of(CountPlacement.of(5),
