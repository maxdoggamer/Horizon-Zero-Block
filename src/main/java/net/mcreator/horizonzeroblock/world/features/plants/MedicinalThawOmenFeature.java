...
public class MedicinalThawOmenFeature extends RandomPatchFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils
				.register("horizon_zero_block:medicinal_thaw_omen", FEATURE,
						FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
								new SimpleBlockConfiguration(
										BlockStateProvider.simple(HorizonZeroBlockModBlocks.MEDICINAL_THAW_OMEN.get().defaultBlockState())),
								List.of(), 64));
		PLACED_FEATURE = PlacementUtils.register("horizon_zero_block:medicinal_thaw_omen", CONFIGURED_FEATURE, List.of(CountPlacement.of(5),
