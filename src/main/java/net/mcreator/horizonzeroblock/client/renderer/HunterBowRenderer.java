...
public class HunterBowRenderer extends EntityRenderer<HunterBowEntity> {
	...
	@Override
	public void render(HunterBowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(HunterBowEntity entity) {
		return texture;
	}
