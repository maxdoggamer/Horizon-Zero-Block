...
public class ModelStrider<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftLeg2 = partdefinition.addOrReplaceChild("LeftLeg2",
				CubeListBuilder.create().texOffs(60, 51).addBox(0.0F, 5.964F, -20.3499F, 2.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg2 = partdefinition.addOrReplaceChild("RightLeg2",
				CubeListBuilder.create().texOffs(14, 60).addBox(-10.0F, 5.964F, -20.3499F, 2.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.0F, 10.0F, 9.0F));
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create(), PartPose.offset(4.0F, 10.0F, 9.0F));
		...
		PartDefinition Neck = partdefinition.addOrReplaceChild("Neck", CubeListBuilder.create(), PartPose.offset(-2.0F, 3.0F, 18.0F));
