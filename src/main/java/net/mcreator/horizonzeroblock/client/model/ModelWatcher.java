...
public class ModelWatcher<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("horizon_zero_block", "model_watcher"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 52).addBox(-3.0F, -5.0F, -10.0F, 6.0F, 6.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(45, 0)
		...
		PartDefinition Neck = partdefinition.addOrReplaceChild("Neck",
				CubeListBuilder.create().texOffs(30, 32).addBox(-2.0F, -2.0F, -19.0F, 4.0F, 4.0F, 20.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.0F, -11.0F, -0.9163F, 0.0F, 0.0F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(34, 56).addBox(-4.0F, -9.0F, -2.0F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 8.0F, 0.0F));
		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -5.0F, -13.0F, 12.0F, 6.0F, 21.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = Left_Leg.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 9).addBox(-1.0F, 0.1648F, -1.1991F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, -1.0F, 0.0F, 0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r3 = Left_Leg.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(8, 27).addBox(-1.0F, 0.211F, -0.6025F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = Right_Leg.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(8, 9).addBox(-1.0F, 0.1648F, -1.1991F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, -1.0F, 0.0F, 0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r5 = Right_Leg.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 27).addBox(-1.0F, -0.755F, -0.8613F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = Tail.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 27).addBox(-2.0F, -1.0F, 0.0F, 4.0F, 4.0F, 21.0F, new CubeDeformation(0.0F)),
