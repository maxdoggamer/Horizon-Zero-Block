...
public class ModelTallneck<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(98, 171).addBox(-6.0F, -59.0F, 0.0F, 3.0F, 54.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 54)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(76, 171).addBox(-10.0F, -59.0F, 0.0F, 3.0F, 54.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 22)
		...
		PartDefinition RightLeg2 = partdefinition.addOrReplaceChild("RightLeg2",
				CubeListBuilder.create().texOffs(159, 136).addBox(-6.0F, -64.0F, -7.0F, 3.0F, 64.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-7.0F, 24.0F, 0.0F));
		PartDefinition LeftLeg2 = partdefinition.addOrReplaceChild("LeftLeg2",
				CubeListBuilder.create().texOffs(50, 160).addBox(3.0F, -64.0F, -7.0F, 3.0F, 64.0F, 10.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Neck = partdefinition.addOrReplaceChild("Neck",
				CubeListBuilder.create().texOffs(164, 56).addBox(0.0F, -131.0F, 10.0F, 3.0F, 2.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(0, 76)
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-26.0F, -158.0F, -23.0F, 50.0F, 4.0F, 50.0F, new CubeDeformation(0.0F)),
