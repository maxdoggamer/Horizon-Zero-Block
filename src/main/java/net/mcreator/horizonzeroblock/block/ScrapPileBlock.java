...
public class ScrapPileBlock extends Block implements SimpleWaterloggedBlock {
	...
	public ScrapPileBlock() {
		super(BlockBehaviour.Properties.of(Material.METAL).sound(SoundType.METAL).strength(2.3f, 10f).speedFactor(0f).jumpFactor(0f).noOcclusion().isRedstoneConductor((bs, br, bp) -> false));
