	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 243)
						.addBox(-75.0F, -356.0F, 10.0F, 142.0F, 9.0F, 129.0F, new CubeDeformation(0.0F)).texOffs(0, 312)
						.addBox(3.0F, -387.0F, 33.0F, 10.0F, 35.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition Neck = partdefinition.addOrReplaceChild("Neck",
				CubeListBuilder.create().texOffs(405, 126)
						.addBox(5.0F, -324.0F, -9.0F, 10.0F, 6.0F, 57.0F, new CubeDeformation(0.0F)).texOffs(405, 63)
						.addBox(5.0F, -280.0F, -2.0F, 10.0F, 6.0F, 57.0F, new CubeDeformation(0.0F)).texOffs(320, 381)
		...
		PartDefinition cube_r1 = Neck
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(0, 381).addBox(-17.0F, -349.0F, 61.0F, 32.0F, 198.0F, 30.0F,
		...
		PartDefinition cube_r2 = Body
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(0, 0).addBox(-34.0F, -165.0F, -90.0F, 66.0F, 52.0F, 191.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0873F, 0.0F, 0.0F));

		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(124, 381)
				.addBox(-39.0F, -140.0F, -85.0F, 10.0F, 140.0F, 21.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(323, 0)
				.addBox(27.0F, -140.0F, -85.0F, 10.0F, 140.0F, 21.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition LeftLeg2 = partdefinition.addOrReplaceChild("LeftLeg2", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-39.0F, -152.0F, 46.0F, 10.0F, 152.0F, 30.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition RightLeg2 = partdefinition.addOrReplaceChild("RightLeg2", CubeListBuilder.create().texOffs(80, 0)
				.addBox(27.0F, -152.0F, 46.0F, 10.0F, 152.0F, 30.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
