...
public class ModelCorruptor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "corruptor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(82, 0)
				.addBox(-9.0F, -7.0F, -8.0F, 18.0F, 17.0F, 18.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 2.0F, 0.0F));

		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(32, 91)
						.addBox(-3.0F, -14.0F, -24.0F, 6.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(0, 115)
						.addBox(-5.0F, -16.0F, -20.0F, 10.0F, 12.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(0, 50)
						.addBox(-10.0F, -19.0F, -16.0F, 20.0F, 8.0F, 33.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, 0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(108, 99)
						.addBox(2.0F, -32.0F, 2.0F, 10.0F, 8.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(82, 0)
		...
		PartDefinition cube_r3 = Body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(40, 115)
						.addBox(-12.0F, -32.0F, 2.0F, 10.0F, 8.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(136, 134)
						.addBox(-9.0F, -32.0F, 5.0F, 4.0F, 14.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, 0.0F, 0.0F, -0.1309F));

		PartDefinition cube_r4 = Body
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(0, 0).addBox(-11.0F, -14.0F, -14.0F, 22.0F, 12.0F, 38.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, 0.48F, 0.0F, 0.0F));

		PartDefinition Sting = partdefinition.addOrReplaceChild("Sting", CubeListBuilder.create(),
				PartPose.offset(0.0F, -14.0F, 17.0F));

		PartDefinition cube_r5 = Sting.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(78, 99).addBox(-3.0F, 41.0F, -55.0F, 6.0F, 3.0F, 18.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 18.0F, -17.0F, -2.4435F, 0.0F, 0.0F));

		PartDefinition cube_r6 = Sting.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(112, 117).addBox(-3.0F, 55.0F, -45.0F, 6.0F, 3.0F, 14.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 18.0F, -17.0F, -2.7053F, 0.0F, 0.0F));

		PartDefinition cube_r7 = Sting.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(73, 50).addBox(-4.0F, 62.0F, 0.0F, 8.0F, 8.0F, 16.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 18.0F, -17.0F, 2.7053F, 0.0F, 0.0F));

		PartDefinition cube_r8 = Sting.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(90, 75).addBox(-4.0F, 55.0F, 16.0F, 8.0F, 8.0F, 16.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 18.0F, -17.0F, 2.2253F, 0.0F, 0.0F));

		PartDefinition cube_r9 = Sting.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(0, 91).addBox(-4.0F, 34.0F, 33.0F, 8.0F, 8.0F, 16.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 18.0F, -17.0F, 1.6144F, 0.0F, 0.0F));

		PartDefinition cube_r10 = Sting.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(48, 91).addBox(-4.0F, 5.0F, 35.0F, 8.0F, 8.0F, 16.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 18.0F, -17.0F, 0.9599F, 0.0F, 0.0F));

		PartDefinition cube_r11 = Sting
				.addOrReplaceChild("cube_r11",
						CubeListBuilder.create().texOffs(107, 37).addBox(-4.0F, -12.0F, 24.0F, 8.0F, 8.0F, 13.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition LeftLegFront = partdefinition.addOrReplaceChild("LeftLegFront",
				CubeListBuilder.create().texOffs(24, 50).addBox(22.1924F, 4.0F, -0.7071F, 2.0F, 9.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = LeftLegFront.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(0, 0).addBox(-18.0F, -21.0F, -2.0F, 6.0F, 24.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = LeftLegFront.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(120, 134).addBox(28.0F, -18.0F, -16.0F, 4.0F, 18.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition RightLegFront = partdefinition.addOrReplaceChild("RightLegFront",
				CubeListBuilder.create().texOffs(24, 0).addBox(-24.364F, 5.0F, -0.7071F, 2.0F, 9.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = RightLegFront.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(0, 50).addBox(12.0F, -24.0F, -2.0F, 6.0F, 24.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = RightLegFront.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(36, 133).addBox(-35.0F, -18.0F, -16.0F, 4.0F, 18.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftLegBack = partdefinition.addOrReplaceChild("LeftLegBack",
				CubeListBuilder.create().texOffs(24, 22).addBox(21.6066F, 4.0F, -2.1213F, 2.0F, 9.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = LeftLegBack.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(80, 120).addBox(-18.0F, -19.0F, -2.0F, 6.0F, 24.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = LeftLegBack.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(104, 134).addBox(26.0F, -18.0F, 14.0F, 4.0F, 18.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition RightLegBack = partdefinition.addOrReplaceChild("RightLegBack",
				CubeListBuilder.create().texOffs(24, 11).addBox(-24.8995F, 4.0F, -1.4142F, 2.0F, 9.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = RightLegBack.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(122, 58).addBox(14.0F, -21.0F, -2.0F, 6.0F, 24.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = RightLegBack.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(52, 133).addBox(-32.0F, -18.0F, 14.0F, 4.0F, 18.0F, 4.0F,
						new CubeDeformation(0.0F)),
